...
function Login() {
  ...
  return (
    <div>
        <Link to = "/home"><div className = "w-100 d-flex justify-content-center mt-4">
    ...
    <div className="login-form">
            ...
            <div className = "form-text">Don't have an account? <a href="#" onClick={googleSignIn}>Create an account</a></div>
            </form>
        </div>
    </div>
  );
