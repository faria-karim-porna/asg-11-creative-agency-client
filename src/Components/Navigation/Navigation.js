...
const Navigation = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="#"><img src = {logo} className = "img-fluid w-25"/></a>
                ...
                <ul className="navbar-nav ml-auto mt-auto">
                    ...
                    <li className="nav-item">
                        <a className="nav-link mr-5" href="#">
                            {!email ? <Link to = "/login" className = "link"><button className = "btn btn-dark">Login</button></Link> : <button className = "btn btn-dark" onClick = {signOut}>Log out</button>}
                        </a>
                    </li>
