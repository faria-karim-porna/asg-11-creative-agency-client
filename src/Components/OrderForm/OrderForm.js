...
const OrderForm = () => {
    ...
    useEffect(() => {
        fetch('https://boiling-eyrie-70521.herokuapp.com/oneService?serviceTitle='+serviceTitle)
        .then(res => res.json())
        .then(data => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch('https://boiling-eyrie-70521.herokuapp.com/addOrder', {
            method: 'POST',
            body: formData
        })
            ...
            <div className = "col-md-9">
                   ...
                   <div className = "row form-class">
                        <div className = "col-md-12">
                            <input type = "text" placeholder="Your name / company's name" name = "name" className = "w-100 pl-4" onBlur={handleBlur} required></input>
                        </div>
                        <div className = "col-md-12">
