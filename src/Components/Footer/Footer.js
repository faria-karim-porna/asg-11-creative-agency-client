    ...
    return (
       <div className = "footer-bg">
            ...
            <div className="col-md-6 footer-form">
                <form>
                    <input type = "text" placeholder = "Your email address" className = "w-75"></input>
                    <input type = "text" placeholder = "Your name / company’s name" className = "w-75"></input>
                    <textarea type = "text" placeholder = "Your message" className = "w-75 message" ></textarea>
                </form>
